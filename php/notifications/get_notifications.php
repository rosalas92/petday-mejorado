...
try {
    ...
    $stmt = $pdo->prepare("SELECT id_notificacion, tipo, id_entidad_relacionada, titulo, mensaje, leida, fecha_envio FROM notificaciones WHERE id_usuario = :user_id ORDER BY fecha_envio DESC LIMIT 10");
